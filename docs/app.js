...
function renderKPIs(){
  ...
  document.getElementById('kpi-strip').innerHTML=`
    ...
    <div class="kpi-card c-mku"><div class="kpi-icon mku">🏢</div><div class="kpi-label">MKU Revenue</div><div class="kpi-value mku">${fmtRp(mkuRev)}</div>${prevD?growthArr(mkuRev,prevD?getSummary(prevD).mku_rev||0:0):''}<div class="kpi-sub">MKU Bali</div></div>
    <div class="kpi-card c-mks"><div class="kpi-icon mks">🏢</div><div class="kpi-label">MKS Revenue</div><div class="kpi-value mks">${fmtRp(mksRev)}</div>${prevD?growthArr(mksRev,prevD?getSummary(prevD).mks_rev||0:0):''}<div class="kpi-sub">MKS Bali</div></div>
